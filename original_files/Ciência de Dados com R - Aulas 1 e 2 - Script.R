...
setwd("C:\\Users\\55219\\OneDrive\\Área de Trabalho\\Curso")
setwd("C:/Users/55219/OneDrive/Área de Trabalho/Curso")
...
x >= 9
x[x >= 9] # elementos de x maiores ou iguais a 10
which(x >= 9) # posição dos elementos de x maiores ou iguais a 10
x[which(x >= 9)]
...
if (x == 6) {
  ...
  print("Poxa... ou tem mais do que 6 vitórias!")
}
...
f = function(x){
  ...
  dobro = 2*x
  list(soma_linhas, soma_colunas, dobro)
}
